...
All-in-One WP Migration (ai1wm) stores backups in its own `.wpress` format. FMW restores them so existing backups keep working. This page records what FMW relies on. It was checked against archives made by ai1wm 7.85 and 7.111.
